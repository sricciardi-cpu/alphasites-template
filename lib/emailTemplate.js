...
<head>
  ...
  <title>Confirmación de compra — ${tenant.email.marca_display}</title>
</head>
                ...
                <tr>
                  <td>
                    <p style="margin:0; font-size:22px; font-weight:800; color:#ffffff; letter-spacing:-0.5px;">
                      ⚡ ${tenant.email.marca_display}
                    </p>
                    <p style="margin:6px 0 0; font-size:13px; color:#a1a1aa;">${tenant.email.slogan_display}</p>
                  </td>
                  <td align="right">
